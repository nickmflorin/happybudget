...
export interface UnauthenticatedMenuProps<R extends Table.RowData, M extends Model.HttpModel = Model.HttpModel> {
...
const UnauthenticatedMenu = <R extends Table.RowData, M extends Model.HttpModel = Model.HttpModel>(
