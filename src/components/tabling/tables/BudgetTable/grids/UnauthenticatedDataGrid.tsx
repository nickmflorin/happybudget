...
const DG = DataGrid<any, any, any, UnauthenticatedBudgetDataGridProps<any, any>>()(UnauthenticatedGrid) as {
  <R extends Table.RowData, M extends Model.Model = Model.Model>(
    props: DataGridProps<R, M, Model.BudgetGroup>
  ): JSX.Element;
};

const DGW = unauthenticateDataGrid<any, any, Model.BudgetGroup, UnauthenticatedBudgetDataGridProps<any, any>>()(DG);
