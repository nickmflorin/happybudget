...
const DG = DataGrid<any, any, Model.BudgetGroup, AuthenticatedBudgetDataGridProps<any>>()(AuthenticatedGrid) as {
  <R extends Table.RowData, M extends Model.Model = Model.Model>(
    props: DataGridProps<R, M, Model.BudgetGroup>
  ): JSX.Element;
};

const DGW = authenticateDataGrid<any, any, Model.BudgetGroup, AuthenticatedBudgetDataGridProps<any>>()(DG);

export default BudgetDataGrid<any, any, AuthenticatedBudgetDataGridProps<any>>(DGW) as {
  <R extends Table.RowData, M extends Model.Model = Model.Model>(
