...
export type AnchorProps<V extends ui.ButtonVariant = ui.ButtonVariant> = _ClickableProps<V> & {
  /**
   * The {@link ForwardedRef} that can be optionally passed through to the underlying
   * {@link HTMLButtonElement}.
   *
...
const useClickableProps = <V extends ui.ButtonVariant = ui.ButtonVariant>(
...
const BaseAnchor = <V extends ui.ButtonVariant = ui.ButtonVariant>({
  onClick,
  disabled,
  variant,
  locked,
 ...
 * @see {Button}
 */
export const Anchor = <V extends ui.ButtonVariant = ui.ButtonVariant>({
  to,
  ...props
