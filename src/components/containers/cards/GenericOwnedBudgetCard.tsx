...
export type GenericOwnedBudgetCardProps = Omit<
  GenericBudgetCardProps<Model.SimpleBudget>,
  "cornerActions"
> & {
...
const GenericOwnedBudgetCard = ({
  deleting,
  onEdit,
  onDelete,
  ...props
}: GenericOwnedBudgetCardProps): JSX.Element => (
  <GenericBudgetCard
    {...props}
