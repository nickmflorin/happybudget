...
export const selectContactsLoading = (state: Modules.ApplicationStore) => state.user.contacts.loading;
export const selectContactsSearch = (state: Modules.ApplicationStore) => state.user.contacts.search;
