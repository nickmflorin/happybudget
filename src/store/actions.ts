...
export const requestContactsAction = redux.actions.createAction<Redux.RequestPayload>("contacts.Request");
...
export const setContactsSearchAction = redux.actions.createAction<string>("user.contacts.SetSearch");
...
export const responseFilteredContactsAction = redux.actions.createAction<Http.RenderedListResponse<Model.Contact>>(
  "user.contacts.ResponseFiltered"
);
export const responseSubAccountUnitsAction = redux.actions.createAction<Http.RenderedListResponse<Model.Tag>>(
  "budget.subaccountunits.Response"
);
export const responseFringeColorsAction =
  redux.actions.createAction<Http.RenderedListResponse<string>>("budget.fringecolors.Response");
export const responseActualTypesAction =
  redux.actions.createAction<Http.RenderedListResponse<Model.Tag>>("budget.actualstypes.Response");
