...
export const syncCheckoutSession = services.patchService<Http.SyncCheckoutSessionPayload, Model.User>([
  "billing",
  "sync-checkout-session"
]);

export const createPortalSession = services.postService<Record<string, never>, { redirect_url: string }>([
  "billing",
  "portal-session"
]);
