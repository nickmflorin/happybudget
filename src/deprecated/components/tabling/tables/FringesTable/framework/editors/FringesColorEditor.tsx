...
import { ui } from "lib";
import { ColorGrid } from "deprecated/components/tagging";
...
>(
  ...
  const colorsLoading = useSelector(
    (s: Application.Store) => store.selectors.selectFringeColorStore(s).loading,
  );
