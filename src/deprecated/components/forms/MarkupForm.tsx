...
import { ChildrenSelect, Input, PercentInput, MarkupUnitSelect } from "deprecated/components/fields";

type MarkupFormValues = Omit<Http.MarkupPayload, "rate"> & { readonly rate: string };

type MarkupFormProps<PARENT extends Model.Account | Model.SubAccount> =
  FormProps<MarkupFormValues> & {
