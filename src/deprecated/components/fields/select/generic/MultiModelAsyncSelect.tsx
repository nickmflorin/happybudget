...
type _MultiModelAsyncSelectProps<
  ...
  G extends SelectGroupBase<ModelSelectOption<M>> = SelectGroupBase<ModelSelectOption<M>>,
> = BaseProps<M, G> &
  hocs.MultiModelSelectInjectedProps<M> &
  hocs.MultiModelAsyncSelectInjectedProps<M>;
...
const WithMulti = hocs.withMultiModelSelect<any, any, _MultiModelAsyncSelectProps<any, any>>(
  MultiAsyncSelect,
);
