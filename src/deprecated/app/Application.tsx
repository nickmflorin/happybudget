...
import { NotFoundRoute, PathParamsRoute } from "deprecated/components/routes";
...
const selectProductPermissionModalOpen = (state: Application.Store) =>
  state.productPermissionModalOpen;
