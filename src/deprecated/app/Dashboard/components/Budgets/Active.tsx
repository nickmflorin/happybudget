...
import { BudgetEmptyIcon } from "deprecated/components/svgs";
import { BudgetCard } from "deprecated/components/containers/cards";
  ...
  return (
    <GenericOwnedBudget
      ...
      onUpdateOrdering={(o: Redux.UpdateOrderingPayload) =>
        dispatch(actions.updateBudgetsOrderingAction(o, {}))
      }
      ...
      renderCard={(params: RenderGenericOwnedBudgetCardParams) => (
        <BudgetCard
          ...
          onArchived={(b: Model.UserBudget) => {
            ...
            dispatch(
              store.actions.updateLoggedInUserMetricsAction(
                { metric: "num_archived_budgets", change: "increment" },
                {},
              ),
            );
          }}
