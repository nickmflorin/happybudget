...
declare type RenderPropChild<
  PARAMS,
  P extends Record<string, unknown> = Record<string, unknown>,
> = (p: PARAMS) => import("react").ReactElement<P, string>;

// Adopted from `utility-types` and scoped to this project.
type Optional<
  T extends Record<string, unknown>,
  K extends keyof T = keyof T,
> = import("utility-types").Optional<T, K>;
type PickOptional<T extends Record<string, unknown>, K extends keyof T = keyof T> = Optional<
  Pick<T, K>,
  K
>;
