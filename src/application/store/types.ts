...
export type ActualTableStore = TableStore<ActualRowData> & {
  readonly owners: AuthenticatedModelListStore<Model.ActualOwner>;
};
export type FringeTableStore = TableStore<FringeRowData>;
export type SubAccountTableStore = BudgetTableStore<SubAccountRowData>;
export type ContactTableStore = TableStore<ContactRowData>;
export type AccountTableStore = BudgetTableStore<AccountRowData>;
...
type PublicModuleReducers = ReducersMapObject<PublicModuleStores>;
type AuthenticatedModuleReducers = ReducersMapObject<AuthenticatedModuleStores>;
...
export type ApplicationStore = AuthenticatedModuleStores & {
  readonly loading: boolean;
  readonly user: Model.User | null;
  readonly contacts: AuthenticatedModelListStore<Model.Contact>;
  readonly filteredContacts: AuthenticatedModelListStore<Model.Contact>;
  readonly actualTypes: ModelListStore<Model.Tag>;
  readonly fringeColors: ListStore<string>;
  readonly subaccountUnits: ModelListStore<Model.Tag>;
...
> {
  ...
  /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
  readonly rootReducer: Reducer<S, any>;
