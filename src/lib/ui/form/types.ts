export type RootFormInstance<T> = import("antd/lib/form").FormInstance<T>;
export type RootFormProps<T> = import("antd/lib/form").FormProps<T>;
...
export type FormField<M> = { readonly name: keyof M; readonly value: M[keyof M] };
...
export type HeaderTemplateFormData = {
...
export type ExportPdfFormOptions = {
  readonly columns: string[];
  readonly excludeZeroTotals: boolean;
  readonly date: string;
};

export type IExportFormRef<O extends ExportPdfFormOptions = ExportPdfFormOptions> = {
  readonly getFormData: () => O;
};

export type ExportBudgetPdfFormOptions = ExportPdfFormOptions & {
...
export type ExportActualsPdfFormOptions = ExportPdfFormOptions & {
  readonly header: string | null;
};
