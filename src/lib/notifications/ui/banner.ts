 ...
 */
export const notify = (notifications: SingleOrArray<UINotificationType>, opts?: UINotificationOptions) =>
 ...
 */
export const clear = (ids: SingleOrArray<UINotification["id"]> | undefined) => RootClear("banner", ids);
 ...
 */
export const handleRequestError = (e: Error, opts?: UINotificationOptions) => RootHandleRequestError("banner", e, opts);
