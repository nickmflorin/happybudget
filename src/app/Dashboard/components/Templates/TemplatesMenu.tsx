...
const selectTemplatesSearch = (state: Modules.Authenticated.Store) => state.dashboard.templates.search;
const selectCommunityTemplatesSearch = (state: Modules.Authenticated.Store) => state.dashboard.community.search;
