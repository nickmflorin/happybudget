...
export const responseBudgetAction =
  creator<Http.RenderedDetailResponse<Model.Template>>("Response");
export const requestBudgetAction = creator<Redux.RequestPayload, C>("Request");
export const updateBudgetInStateAction =
  creator<Redux.UpdateModelPayload<Model.Template>>("UpdateInState");
