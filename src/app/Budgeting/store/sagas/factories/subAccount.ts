...
export type SubAccountTasksActionMap<B extends Model.Budget | Model.Template> = Redux.BudgetTableActionCreatorMap<C> & {
  budget: {
...
export type SubAccountTaskSet = Redux.BudgetTableTaskMap<R, C> & {
...
export const createSubAccountTaskSet = <B extends Model.Budget | Model.Template>(
  ...
  selectSubAccountId: (state: Modules.Authenticated.StoreObj) => number | null,
