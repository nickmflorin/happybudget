...
function* request(action: Redux.Action<null, Redux.WithActionContext<{ readonly budgetId: number }>>): SagaIterator {
...
const rootSaga = redux.createListSaga<number, Redux.WithActionContext<{ readonly budgetId: number }>>({
  tasks: { request },
