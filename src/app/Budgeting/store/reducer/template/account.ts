...
const rootReducer: Reducer<Redux.Template.AccountStore, Redux.Action<any>> = combineReducers({
  id: createSimplePayloadReducer<number | null>(ActionType.Template.Account.SetId, null),
  detail: createDetailResponseReducer<
    Model.TemplateAccount,
    Redux.DetailResponseStore<Model.TemplateAccount>,
    Redux.Action
  >({
  ...
  subaccounts: createTemplateSubAccountsReducer({
    ...
    Placeholders: {
      AddToState: ActionType.Template.Account.SubAccounts.Placeholders.AddToState,
      Activate: ActionType.Template.Account.SubAccounts.Placeholders.Activate,
      RemoveFromState: ActionType.Template.Account.SubAccounts.Placeholders.RemoveFromState,
      UpdateInState: ActionType.Template.Account.SubAccounts.Placeholders.UpdateInState
    }
  })
});
